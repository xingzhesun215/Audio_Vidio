package com.sun.eg11.mediacodec;
...
import com.sun.eg11.Constants;
import com.sun.eg11.MyApplication;
import com.sun.eg11.filter.AFilter;
import com.sun.eg11.filter.NoFilter;
import com.sun.eg11.filter.RotationOESFilter;
import com.sun.eg11.gpufilter.basefilter.GPUImageFilter;
import com.sun.eg11.media.VideoInfo;
import com.sun.eg11.utils.EasyGlUtils;
import com.sun.eg11.utils.MatrixUtils;
import com.sun.eg11.utils.OpenGlUtils;
...
//        st.getTransformMatrix(mSTMatrix);//当视频角度不为0时,这里会导致视频方向不对
    ...
    private int createProgram(String vertexSource, String fragmentSource) {
        Logutil.e("createProgram0");
        int vertexShader = loadShader(GLES20.GL_VERTEX_SHADER, vertexSource);
        Logutil.e("createProgram1");
        if (vertexShader == 0) {
            return 0;
        }
        Logutil.e("createProgram2");
        int pixelShader = loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentSource);
        Logutil.e("createProgram3");
        if (pixelShader == 0) {
            return 0;
        }
        Logutil.e("createProgram4");
        int program = GLES20.glCreateProgram();
        Logutil.e("createProgram5");
        checkGlError("glCreateProgram");
        if (program == 0) {
            Log.e(TAG, "Could not create program");
        }
        Logutil.e("createProgram6");
