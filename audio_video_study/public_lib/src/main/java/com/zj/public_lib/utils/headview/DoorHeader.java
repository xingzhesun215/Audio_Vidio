...
public class DoorHeader extends FrameLayout implements PtrUIHandler {
    ...
    public DoorHeader(Context context) {
        this(context, null);
    }

    public DoorHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DoorHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        ivWindmill.setImageResource(R.drawable.door_head_anim);
