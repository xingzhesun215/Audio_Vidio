...
public class ThemeUtils {
    ...
    public static void setChageTheme(Activity activity, View view) {
        if (view == null) {
            return;
        }
        switch (ThemeHelper.getTheme(activity)) {
            case ThemeHelper.CARD_SAKURA:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_main_white_title));
                break;
            case ThemeHelper.CARD_HOPE:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_hope_title));
                break;
            case ThemeHelper.CARD_STORM:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_storm_title));
                break;
            case ThemeHelper.CARD_WOOD:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_wood_title));
                break;
            case ThemeHelper.CARD_LIGHT:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_light_title));
                break;
            case ThemeHelper.CARD_THUNDER:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_thunder_title));
                break;
            case ThemeHelper.CARD_SAND:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_red_title));
                break;
            case ThemeHelper.CARD_FIREY:
                view.setBackground(activity.getResources().getDrawable(R.drawable.shape_firey_title));
                break;
        }
    }
}
